...
import { Table1ApiConstants } from './table-1.api-constants';
...
public baseService = inject(BaseService);
	  ...
	  getProtoTypingData(): Observable<any> {
	      const subject:Observable<Table1Base> = new Observable(observer => {
	        const data =  require('base/assets/sample-data/table-1.json');
	    ...
	    let data: any = {};
	    const subject: Observable<Table1Base> = new Observable(observer => {
	      const response = require('base/assets/sample-data/table-1.json');
	      response.map((o: any) => {
    ...
    in1AutoSuggestService(...args: any):Observable<any>{
        const serviceOpts = Table1ApiConstants.in1AutoSuggestService;
        const params= args[0];
    ...
    siduniqueAutoSuggestService(...args: any):Observable<any>{
        const serviceOpts = Table1ApiConstants.siduniqueAutoSuggestService;
        const params= args[0];
