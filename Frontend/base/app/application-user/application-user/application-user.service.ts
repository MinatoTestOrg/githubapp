...
public baseService = inject(BaseService);
    ...
    siduniqueAutoSuggestService(...args: any):Observable<any>{
        const serviceOpts = ApplicationUserApiConstants.siduniqueAutoSuggestService;
        const params= args[0];
    ...
    emailprimaryAutoSuggestService(...args: any):Observable<any>{
        const serviceOpts = ApplicationUserApiConstants.emailprimaryAutoSuggestService;
        const params= args[0];
