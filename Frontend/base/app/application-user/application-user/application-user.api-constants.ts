...
export class ApplicationUserApiConstants {
    ...
    public static readonly siduniqueAutoSuggestService: any = {
        url: '/rest/applicationusers/autosuggest/sidunique',
        method: 'GET',
        showloading: true
    };
    ...
    public static readonly emailprimaryAutoSuggestService: any = {
        url: '/rest/applicationusers/autosuggest/emailprimary',
        method: 'GET',
        showloading: true
    };
